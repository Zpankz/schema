...
const ANTIGRAVITY_CLIENT_ID: &str =
    ""; // REDACTED for GitHub push protection; set JCODE_ANTIGRAVITY_CLIENT_ID (see upstream 1jehuang/jcode)
const ANTIGRAVITY_CLIENT_SECRET: &str = ""; // REDACTED for GitHub push protection; set JCODE_ANTIGRAVITY_CLIENT_SECRET (see upstream 1jehuang/jcode)
